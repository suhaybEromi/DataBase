...
<div class="row m-3 justify-content-center">
    <div class="col-lg-4 col-12 text-center">
        ...
        <br>
        <span class="text-center mt-3 mb-3 text-light">Barcode : <b id="barcode"></b></span>
        <br>
        <span class="notify text-center mt-3 mb-3 text-danger"></span>
        <br>
        <button title="Play" class="btn btn-light m-2" id="play" type="button" data-toggle="tooltip">Play</button>
