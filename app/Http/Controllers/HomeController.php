...
class HomeController extends Controller
{
    ...
    public function AddCashier(Request $request){
        ...
        if($validator->fails()){
            ...
            return $create_user ? redirect('cashier')->with('result' , 'The Cashier Was Successfully !') :redirect('cashier')->with('result' , 'Some Thing Went Wrong !');   
        }
    }
    ...
    public function AddSupplier($status , $id , Request $request){
        ...
        public function add_stock($status , $id , Request $request){
            ...
            if($validator->fails()){
                ...
                return $stocks ? redirect('buy')->with('result' , 'The Stocks buy Was Successfuly !') : redirect('buy')->with('result' , 'Some Thing Went Wrong !');   
            }
